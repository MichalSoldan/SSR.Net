...
namespace SSR.Net.Extensions
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static IHtmlContent React<T>(this IHtmlHelper htmlHelper, string componentName, T props, string htmlTag = "", string containerClass = "", string containerId = "", bool clientOnly = false, bool serverOnly = false, Action<Exception, string, string> exceptionHandler = null) where T : class, new()
        {
            try
            {
                RenderedComponent reactComponent;

                var renderer = htmlHelper.ViewContext.HttpContext.RequestServices.GetService(typeof(IReact19Renderer)) as IReactRenderer;
            ...
            {
                exceptionHandler?.Invoke(ex, componentName, string.Empty);
            }
            return null;
        }
