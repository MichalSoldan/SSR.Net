...
namespace SSR.Net.Extensions
{
    ...
    public static class HtmlHelperExtensions
    {
        ...
        public static ReactRendererBase Renderer { get; set; }
        ...
        //public static IHtmlContent React<T>(this IHtmlHelper htmlHelper, string componentName, T props, string htmlTag = null, string containerId = null, bool clientOnly = false, bool serverOnly = false, string containerClass = null, Action<Exception, string, string> exceptionHandler = null)
        //{
        //    var renderer = (React19Renderer)htmlHelper.ViewContext.HttpContext.RequestServices.GetService(typeof(React19Renderer));

        //        var reactComponent = renderer.RenderComponent(componentName, props, containerId, clientOnly, serverOnly);
        ...
        //// Returns:
        ////     The component's HTML
        //public static IHtmlContent ReactWithInit<T>(this IHtmlHelper htmlHelper, string componentName, T props, string htmlTag = null, string containerId = null, bool clientOnly = false, bool serverOnly = false, string containerClass = null, Action<Exception, string, string> exceptionHandler = null)
        //{
        //    try
        //    {
